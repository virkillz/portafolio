defmodule PortafolioWeb.PageController do
  ...
  def index(conn, _params) do
    conn
    |> render("index.html", layout: {PortafolioWeb.LayoutView, "fe.html"})
  end

  def login(conn, _params) do
    changeset = Account.change_user(%User{})

    render(conn, "login.html", layout: {PortafolioWeb.LayoutView, "fe.html"}, changeset: changeset)
  end
  ...
  def lgn(conn, _params) do
    ...
    render(conn, "login-nosocial.html",
      layout: {PortafolioWeb.LayoutView, "fe.html"},
      changeset: changeset
    )
  end
  ...
  def recover(conn, _params) do
    render(conn, "recover.html", layout: {PortafolioWeb.LayoutView, "fe.html"})
  end
