defmodule PortafolioWeb.UserController do
  use PortafolioWeb, :controller

  alias Portafolio.Logging
  ...
  def create(conn, %{"user" => user_params}) do
    filename = upload_local_image(user_params["avatar"])
  ...
  def upload_local_image(upload) do
    if upload do
  ...
  def login(conn, _params) do
    ...
    render(conn, "login.html",
      layout: {PortafolioWeb.LayoutView, "center.html"},
      changeset: changeset
    )
  end
